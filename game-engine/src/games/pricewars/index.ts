...
import type { PriceWarsItem } from './types.js';
...
export const SAMPLE_ITEMS: PriceWarsItem[] = [
...
export const PriceWarsGameType: GameType = {
  id: 'pricewars',
  name: 'PRICEWARS',
  ...
  createMatch: (config: MatchConfig) => {
    ...
    return new PriceWarsMatch(
      config.players,
      config.prizePool ?? 100,
      { items: SAMPLE_ITEMS }
    );
  },
};
